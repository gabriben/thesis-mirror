...
Historically, personalization has been used as an umbrella term for approaches more akin to targeting user segments/groups than actually serving each single user differently (as the term personalization seems to hint at) \gab{This is my point of view, but I don't really have a ref for that. I don't know if this remark has its place here.}. 
