...
Then, they see a customized home page with various horizontal \emph{recommendation} strips (see Figure~\ref{fig:VLStrip} \gab{do we need this figure if we already have the diagram?}). 
